...
namespace Snakat
{
    public class Permission : MonoBehaviour
    {
        ...
        internal static Permission Instance {
            get {
        ...
        private static void CreateInstanceIfNeeded ()
        {
            ...
            _Instance = FindObjectOfType<Permission> ();
            if (_Instance != null) {
                return;
            }

            var go = new GameObject ("SnakatPermission");
            _Instance = go.AddComponent<Permission> ();
        }
        ...
        /// </summary>
        public static IPermissionRequest Permissions (params int[] permissions)
        {
