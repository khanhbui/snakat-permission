...
namespace Snakat.Editor
{
    ...
    internal class SettingInfo
    {
        ...
        private const string FILE_PATH = "Assets/Plugins/iOS/Editor/SnakatPermissionsSetting.json";
    ...
    internal class SnakatPermissionsSettingWindow : EditorWindow
    {
        [MenuItem ("Snakat/Permissions/Settings")]
        public static void Open ()
        {
            var window = GetWindow<SnakatPermissionsSettingWindow> (true, "SnakatPermissionsSetting");
            window.Init ();
        }
  ...
  <iosPods>{0}
    ...
    <iosPod name=""Permission/{0}"" addToAllTargets=""false"">
      <sources>
        ...
        {
            var xmlPath = Path.Combine ("Assets/Plugins/iOS/Editor/", "SnakatPermissionsDependencies.xml");
